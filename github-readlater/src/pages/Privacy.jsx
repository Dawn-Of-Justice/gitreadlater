    ...
    <div className={`${themeClasses.body} min-h-screen py-12`}>
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className={`${themeClasses.card} rounded-lg p-6 mb-8`}>
          ...
          <p className={`mb-4 ${themeClasses.textSecondary}`}>
            GitHub ReadLater uses GitHub's API to access your GitHub account data. We only request the minimum permissions required to provide our services. We do not access private repositories unless specifically granted permission.
          </p>
